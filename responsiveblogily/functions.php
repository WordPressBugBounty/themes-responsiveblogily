...
ThemeEntryPoint::init([
    ...
    'theme_url' => 'https://superbthemes.com/responsiveblogily/',
    'demo_url' => 'https://superbthemes.com/demo/responsiveblogily/',
    'features' => array(
    	array('title'=>'Customize All Fonts'),
    	array('title'=>'Customize All Colors'),
    	array('title'=>'Add Logo Container Background Image'),
    	...
    	array('title'=>'Show Full Post Contents On Blog Feed'),
    	array('title'=>'Full Width Page Template'),
    	array('title'=>'Full Width Post Template'),
    	array('title'=>'Unlock Enhanced Quote Block Design'),
    	array('title'=>'Change Header Background Color')
    )
]);
